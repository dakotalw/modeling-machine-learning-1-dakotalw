...
Splits dataset into training and testing and creates linear regression
for lcavol compared to all other variables.
...
fit <- glmnet(x=x_inp, y=y_out, lambda=seq(0.5, 0, -0.05),alpha=.5)
print(fit$beta)
```
    ...
    ## (Intercept) .         .          .         .            .           .          
    ## lweight     .         .          .         .            .           .          
    ## age         .         .          .         0.0003894864 0.002320975 0.004313701
    ## lbph        .         .          .         .            .           .          
    ## lcp         0.2294623 0.24154340 0.2540724 0.2661649989 0.277441570 0.289274669
    ## pgg45       .         .          .         .            .           .          
    ## lpsa        0.3305721 0.34691310 0.3638096 0.3805189608 0.395973906 0.412018284
    ## svi         0.0926727 0.09997708 0.1059081 0.1105946514 0.114304207 0.116251808
    ## gleason     .         .          .         0.0039626023 0.010940153 0.017462117
    ##                                                                         
    ## (Intercept) .           .           .           .            .          
    ## lweight     .           .           .           .           -0.112933921
    ## age         0.006371217 0.008497991 0.01069908  0.014404395  0.020098113
    ## lbph        .           .           .          -0.028483927 -0.056964741
    ## lcp         0.301759296 0.315005922 0.32915376  0.357468308  0.418530969
    ## pgg45       .           .           .          -0.002397585 -0.009123115
    ## lpsa        0.428723351 0.446159446 0.46440996  0.502969322  0.575230287
    ## svi         0.116073131 0.113352809 0.10757296  0.075176567  0.035283017
    ## gleason     0.023430228 0.028730890 0.03322404  0.087684091  0.224747486
